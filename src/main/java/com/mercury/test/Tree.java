...
import static com.mercury.utils.CommonTool.toHump;
...
public class Tree {
    ...
    public static JSONArray getTree(List<Map<String, Object>> data, String parentId, JSONObject field) {
        ...
        Map<String, JSONArray> child = new HashMap<>();
    ...
    private static Object getValue(Map<String, Object> node, String key, boolean remove) {
        Object value = node.getOrDefault(key, node.getOrDefault(toHump(key), key.toLowerCase()));
